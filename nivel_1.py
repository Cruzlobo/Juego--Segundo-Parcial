...
#Fondo
fondo = pygame.image.load(r"Sprites\MAPA_DIA\0.png").convert()#Acelera el juego y hace que consuma menos recursos
...
personaje = Personaje(diccionario, (130,100), 50,850,10, 3)

monedas = pygame.sprite.Group()  # Grupo para almacenar todas las monedas
moneda = Moneda(900, 800)
moneda2 = Moneda(250, 300) 
moneda3 = Moneda(1100, 700) 
...
imagen_camion = pygame.image.load(r"Sprites\OBJECTOS\CAMION\0.png")

imagen_camion_escalada = pygame.transform.scale(imagen_camion, (500,300))
...
plataforma_puerta["rectangulo"].x = 1800
plataforma_puerta["rectangulo"].bottom = piso["rectangulo"].top 
plataforma_invisible = crear_plataforma("", 540, 30, 458 , 480, False)      
plataforma_invisible5 = crear_plataforma("", 10, 30, 458 , 460, False)
plataforma_invisible6 = crear_plataforma("", 10, 30, 987 , 460, False)
plataforma_invisible2 = crear_plataforma("", 450, 100, 810 , 880, False)
plataforma_invisible11 = crear_plataforma("", 420, 70, 825 , 890, False)
plataforma_invisible3 = crear_plataforma("", 120, 130, 1100, 775, False) 
plataforma_invisible4 = crear_plataforma("", 200, 10, 1280 , 660, False)
plataforma_invisible8 = crear_plataforma("", 200, 10, 1550 , 500, False)
plataforma_invisible9 = crear_plataforma("", 200, 10, 1280 , 400, False)
plataforma_invisible10 = crear_plataforma("", 200, 10, 133 , 390, False)


plataformas = [piso, plataforma_puerta, plataforma_invisible,plataforma_invisible2,
            plataforma_invisible3,plataforma_invisible4,plataforma_invisible5,
            plataforma_invisible6,plataforma_invisible8,plataforma_invisible9,
            plataforma_invisible10,plataforma_invisible11,piso2]
...
mira_Derecha = None
max_enemigos = 4
pygame.mixer.music.load(r'Sonidos\Mapa\GG2JING1300.wav')
...
while True:
    ...
    if tiempo_transcurrido >= duracion_temporizador:
        ...
        personaje = Personaje(diccionario, (150,120), 50,850,10, 3)
        lista_enemigos = Enemigo.crear_lista(plataformas)
        tiempo_inicio = pygame.time.get_ticks()
...
################################################################### 
    ...
    PANTALLA.blit(imagen_camion_escalada,(800, 675))
    PANTALLA.blit(imagen_plataforma,(1280, 660))
    PANTALLA.blit(imagen_plataforma,(1550,500))
    PANTALLA.blit(imagen_plataforma,(1280,400))
    PANTALLA.blit(imagen_plataforma,(133,390))
            ...
            if enemigo.esta_muerto:
                ...
                if tiempo_transcurrido > enemigo.TIEMPO_ANIMACION_MUERTE:
                    ...
                    if len(lista_enemigos) < max_enemigos:
                        nuevo_enemigo = Enemigo.generar_enemigo_aleatorio(3)
    ...
    if contador_enemigos_derrotados == max_enemigos:
        ...
        dibujar_texto("...haremos un ataque nocturno.",fuente,(255,255,255),450,800,PANTALLA)
